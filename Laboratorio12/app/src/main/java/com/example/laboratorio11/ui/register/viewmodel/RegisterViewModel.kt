...
class RegisterViewModel(private val repository: CredentialsRepository) : ViewModel() {
    ...
    private fun register(name: String, email: String, password: String) {
        // Create a coroutine to call the register function from the repository and inside the coroutine set the value of the status
    ...
    companion object {
        // Create a RegisterViewModel Factory
